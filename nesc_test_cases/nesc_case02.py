...
glob_path = os.path.join(data_relative_path, 'Atmospheric_checkcases', 'Atmos_02_TumblingBrickNoDamping', 'Atmos_02_sim_*.csv')
plot_nesc_comparisons(res, glob_path, '02')
