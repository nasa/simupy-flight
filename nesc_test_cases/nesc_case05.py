...
glob_path = os.path.join(data_relative_path, 'Atmospheric_checkcases', 'Atmos_05_DroppedSphereRoundRotation', 'Atmos_05_sim_*.csv')
plot_nesc_comparisons(res, glob_path, '05')
