...
glob_path = os.path.join(data_relative_path, 'Atmospheric_checkcases', 'Atmos_04_DroppedSphereRoundNonRotation', 'Atmos_04_sim_*.csv')
plot_nesc_comparisons(res, glob_path, '04')
