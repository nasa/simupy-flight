...
glob_path = os.path.join(data_relative_path, 'Atmospheric_checkcases', 'Atmos_08_DroppedSphere2DWindShear', 'Atmos_08_sim_*.csv')
plot_nesc_comparisons(res, glob_path, '08')
