...
c_l = 2/(3*ft_per_m)
a_l = b_l
dyn_block =  aerospace_sim_classes.DynamicsBlock(aerospace_sim_classes.get_constant_aero(Cp_b=-1.0, Cq_b=-1.0, Cr_b=-1.0), m, Ixx, Iyy, Izz, Ixy, Iyz, Izx, x,y,z, x,y,z, S_A=S_A, a_l=a_l, b_l=b_l, c_l=c_l, d_l=1.,)
...
import glob
baseline_pds = []
for fname in glob.glob(os.path.join('Atmospheric_checkcases', 'Atmos_03_TumblingBrickDamping', 'Atmos_03_sim_*.csv'),):
