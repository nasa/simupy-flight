...
glob_path = os.path.join(data_relative_path, 'Atmospheric_checkcases', 'Atmos_06_DroppedSphereEllipsoidalNoWind', 'Atmos_06_sim_*.csv')
plot_nesc_comparisons(res, glob_path, '06')
