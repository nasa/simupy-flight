...
glob_path = os.path.join(data_relative_path, 'Atmospheric_checkcases', 'Atmos_16_CircleEquatorDateLine', 'Atmos_16_sim_*.csv')
...
baseline_pds, baseline_pd_labels = get_baselines(glob_path)
